...
import {camelCase, capitalCase, paramCase, snakeCase} from "change-case";
...
const replacements = [
    ...
    {find: 'templateApp', replace: camelCase(projectName) /* converts 'ProjectName' to 'projectName'*/},
    {find: 'template-app', replace: paramCase(projectName) /* converts 'projectName' to 'project-name' */},
    {find: 'template_app', replace: snakeCase(projectName) /* converts 'projectName' to 'project-name' */},
    {find: 'Template App', replace: capitalCase(projectName) /* converts 'ProjectName' to 'Project Name' */},
]
